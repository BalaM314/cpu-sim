...
describe("getStatementDefinition", () => {
	it("should determine the statement definition that a line matches", () => {
		expect(getStatementDefinition({rawText: "", lexemes: [{ type: "hex_number", value: "0"}, { type: "instruction", value: "NOP" }]})?.[0]).toEqual(statements.instruction);
		...
		expect(getStatementDefinition({rawText: "", lexemes: [{ type: "label", value: "sus:"}, { type: "instruction", value: "ADD" }, { type: "hex_number", value: "23"},]})?.[0]).toEqual(statements.instruction);
		expect(getStatementDefinition({rawText: "", lexemes: [{ type: "hex_number", value: "0"}, { type: "instruction", value: "ADD" }, { type: "hex_number", value: "23"},]})?.[0]).toEqual(statements.instruction);
		...
		expect(getStatementDefinition({rawText: "", lexemes: [{ type: "hex_number", value: "0"}, { type: "hex_number", value: "23"}]})?.[0]).toEqual(statements.memoryValue);
